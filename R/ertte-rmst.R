...
#' from 0 to tau`, where `dbase` is the base distribution's density --
#' propagating only `Var(mu)`, not `Var(scale)`,
...
#' uncertainty for a profile far from the mean covariate values.
#'
